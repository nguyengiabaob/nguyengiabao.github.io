  ...
  $(function () {
      ...
      var parallaxSliderOptions = {
        ...
        on: {
          init: function () {
            ...
            console.log("dsadsad", swiper.width);
    ...
    $(function () {
      ...
      $(".marine-project-link").on("click", function () {
        ...
        gsap.to("#home", 0, { display: "none", delay: 0.7 });
        gsap.to(".marine-project", 0, { display: "block", delay: 0.7 });
        gsap.to(".marine-project", 0.5, { scale: 1, delay: 1.1 });
      ...
      $(".forest-project-link").on("click", function () {
        ...
        gsap.to("#home", 0, { display: "none", delay: 0.7 });
        gsap.to(".forest-project", 0, { display: "block", delay: 0.7 });
        gsap.to(".forest-project", 0.5, { scale: 1, delay: 1.1 });
        gsap.to(".project-name", 0.5, { opacity: 0, delay: 2.5 });
        gsap.to("#breaker", { display: "block" });
        gsap.to("#breaker", 0, { display: "none", delay: 1.7 });
      });
      $(".wildlife-project-link").on("click", function () {
        ...
        gsap.to("#home", 0, { display: "none", delay: 0.7 });
        gsap.to(".wildlife-project", 0, { display: "block", delay: 0.7 });
        gsap.to(".wildlife-project", 0.5, { scale: 1, delay: 1.1 });
        gsap.to(".project-name", 0.5, { opacity: 0, delay: 2.5 });
        gsap.to("#breaker", { display: "block" });
        gsap.to("#breaker", 0, { display: "none", delay: 1.7 });
      });
      $(".city-project-link").on("click", function () {
        ...
        gsap.to("#home", 0, { display: "none", delay: 0.7 });
        gsap.to(".city-project", 0, { display: "block", delay: 0.7 });
        gsap.to(".city-project", 0.5, { scale: 1, delay: 1.1 });
        gsap.to(".project-name", 0.5, { opacity: 0, delay: 2.5 });
        gsap.to("#breaker", { display: "block" });
        gsap.to("#breaker", 0, { display: "none", delay: 1.7 });
      });
      ...
      $(".marine-close").on("click", function () {
        ...
        gsap.to("#home", 0, { display: "block", delay: 0.7 });
        gsap.to("#home", 0.5, { scale: 1, delay: 1.1 });
        gsap.to(".project-name", 0.5, { opacity: 1, delay: 1 });
        gsap.to("#breaker", { display: "block" });
        gsap.to("#breaker", 0, { display: "none", delay: 1.7 });
      });
